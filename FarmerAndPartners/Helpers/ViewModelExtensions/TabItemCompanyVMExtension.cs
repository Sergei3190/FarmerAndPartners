...
using FarmerAndPartners.Properties;
    ...
    public static class TabItemCompanyVMExtension
    {
        public static SqlParameter[] GetSqlParameters(this TabItemCompanyViewModel tabItemCompanyViewModel, params DataTable[] dataTables)
        {
            ...
            for (int i = 0; i < dataTables.Length; i++)
            {
                ...
                {
                    case string name when name.Equals(Settings.Default.CompaniesTableName, StringComparison.OrdinalIgnoreCase):
                        ...
                        break;
                    case string name when name.Equals(Settings.Default.UsersTableName, StringComparison.OrdinalIgnoreCase):
                        sqlParameters.SetValue(new SqlParameter
                        {
                            SqlDbType = SqlDbType.Structured,
                            Direction = ParameterDirection.Input,
