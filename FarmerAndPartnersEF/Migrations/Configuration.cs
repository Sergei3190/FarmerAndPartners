namespace FarmerAndPartnersEF.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EF.FarmerAndPartnersEntities>
    {
        ...
        protected override void Seed(EF.FarmerAndPartnersEntities context)
        {
